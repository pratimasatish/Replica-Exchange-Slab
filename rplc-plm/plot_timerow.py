...
parser.add_argument("-row", choices=["x","z"], default="z", help="which direction to average out")
...
data = -1.0 * data
# data = np.genfromtxt('yval' + args.temp + '.txt', delimiter=' ')
...
if args.row == "z":
    ...
    plt.figure()
#     plt.subplot(2,1,1)
    plt.imshow(mean_tx, aspect=len(data)/20, cmap="plasma", origin="lower", vmin=0.65, vmax=0.9, interpolation="none")
