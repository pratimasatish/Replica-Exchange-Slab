...
N_int = len(namelist_370int)

# if args.temp == 370:
#     full_namelist = np.concatenate(( namelist_370, namelist_370int, namelist_370mid, namelist_375int ))
#     temp_list = np.concatenate(( np.ones(N_bias) * 370.0, np.ones(N_int) * 370.0, np.ones(N_int) * 370.0, np.ones(N_int) * 375.0  ))
#     print 'imported 370K'
# else:
#     full_namelist = np.concatenate(( namelist_375, namelist_370int, namelist_370mid, namelist_375int ))
#     temp_list = np.concatenate(( np.ones(N_bias) * 375.0, np.ones(N_int) * 370.0, np.ones(N_int) * 370.0, np.ones(N_int) * 375.0  ))
#     print 'imported 375K'

# k_list = np.concatenate(( np.ones(N_bias) * 1500.0, np.ones(N_int) * 15000.0, np.ones(N_int) * 15000.0, np.ones(N_int) * 15000.0 ))
