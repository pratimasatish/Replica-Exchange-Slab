...
# plot time-avg of non-CG lattice over 25ns
plt.imshow(np.mean(theta_lat[0:25000], axis=0), aspect=0.6, cmap="seismic_r", origin="lower", interpolation="none", vmin=-0.25, vmax=0.12)
plt.xticks(np.arange(0, 12, 1))
plt.yticks(np.arange(0, 20, 1))
plt.xlim(-0.5,11.5)
plt.ylim(-0.5,19.5)
...
plt.imshow(np.mean(theta_lat[25000:50000], axis=0), aspect=0.6, cmap="seismic_r", origin="lower", interpolation="none", vmin=-0.25, vmax=0.12)
plt.xticks(np.arange(0, 12, 1))
plt.yticks(np.arange(0, 20, 1))
plt.xlim(-0.5,11.5)
plt.ylim(-0.5,19.5)
...
for i in np.arange(-0.5,19,1.0):
    plt.hlines(i, -0.5, 11.5, linestyle='solid', linewidth=2)
plt.colorbar()
plt.title('non-CG lattice averaged over 25 - 50 ns')
plt.show()

# plot time-avg of non-CG lattice over third 25ns
plt.imshow(np.mean(theta_lat[50000:75000], axis=0), aspect=0.6, cmap="seismic_r", origin="lower", interpolation="none", vmin=-0.25, vmax=0.12)
plt.xticks(np.arange(0, 12, 1))
plt.yticks(np.arange(0, 20, 1))
plt.xlim(-0.5,11.5)
plt.ylim(-0.5,19.5)
...
for i in np.arange(-0.5,19,1.0):
    plt.hlines(i, -0.5, 11.5, linestyle='solid', linewidth=2)
plt.colorbar()
plt.title('non-CG lattice averaged over 50 - 75 ns')
plt.show()

# plot time-avg of non-CG lattice over last 25ns
plt.imshow(np.mean(theta_lat[75000:100000], axis=0), aspect=0.6, cmap="seismic_r", origin="lower", interpolation="none", vmin=-0.25, vmax=0.12)
plt.xticks(np.arange(0, 12, 1))
plt.yticks(np.arange(0, 20, 1))
plt.xlim(-0.5,11.5)
plt.ylim(-0.5,19.5)
...
for i in np.arange(-0.5,19,1.0):
    plt.hlines(i, -0.5, 11.5, linestyle='solid', linewidth=2)
plt.colorbar()
plt.title('non-CG lattice averaged over last 25 ns')
plt.show()
...
plt.imshow(np.mean(cg_theta[25000:50000], axis=0), aspect=0.6, cmap="seismic_r", origin="lower", interpolation="none", vmin=-0.25, vmax=0.12)
plt.xticks(np.arange(0, 12, 1))
plt.yticks(np.arange(0, 20, 1))
plt.xlim(-0.5,11.5)
plt.ylim(-0.5,19.5)
...
for i in np.arange(-0.5,19,1.0):
    plt.hlines(i, -0.5, 11.5, linestyle='solid', linewidth=2)
plt.colorbar()
plt.title('CG lattice averaged over 25 - 50 ns')
plt.show()

# plot time-avg of CG lattice over third 25ns
plt.imshow(np.mean(cg_theta[50000:75000], axis=0), aspect=0.6, cmap="seismic_r", origin="lower", interpolation="none", vmin=-0.25, vmax=0.12)
plt.xticks(np.arange(0, 12, 1))
plt.yticks(np.arange(0, 20, 1))
plt.xlim(-0.5,11.5)
plt.ylim(-0.5,19.5)
...
for i in np.arange(-0.5,19,1.0):
    plt.hlines(i, -0.5, 11.5, linestyle='solid', linewidth=2)
plt.colorbar()
plt.title('CG lattice averaged over 50 - 75 ns')
plt.show()

# plot time-avg of CG lattice over last 25ns
plt.imshow(np.mean(cg_theta[75000:100000], axis=0), aspect=0.6, cmap="seismic_r", origin="lower", interpolation="none", vmin=-0.25, vmax=0.12)
plt.xticks(np.arange(0, 12, 1))
plt.yticks(np.arange(0, 20, 1))
plt.xlim(-0.5,11.5)
plt.ylim(-0.5,19.5)
...
for i in np.arange(-0.5,19,1.0):
    plt.hlines(i, -0.5, 11.5, linestyle='solid', linewidth=2)
plt.colorbar()
plt.title('CG lattice averaged over last 25 ns')
plt.show()
