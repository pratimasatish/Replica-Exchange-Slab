...
namelist = [-0.750, -0.700, -0.650, -0.625, -0.600, -0.580, -0.560, -0.540, -0.520, -0.500, -0.425, -0.350, -0.275, -0.225, -0.175, -0.125]
...
disord_min = np.mean(theta_axis[np.where(np.abs(theta_axis - -0.325) < 0.005)])
ord_min = np.mean(theta_axis[np.where(np.abs(theta_axis - -0.75) < 0.05)])
disord_F = np.mean(f_i[np.where(np.abs(theta_axis - disord_min) < 0.005)])
ord_F = np.mean(f_i[np.where(np.abs(theta_axis - ord_min) < 0.05)])
...
# compute probability area of different phases
